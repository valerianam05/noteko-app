...
public class AcademicYearService {
  ...
  public AcademicYear findById(UUID id) {
    return academicYearRepository
        .findById(id)
        .orElseThrow(
            () -> new ResourceNotFoundException("Année universitaire introuvable : " + id));
  }
  ...
  public AcademicYear getCurrent() {
    return academicYearRepository
        .findByIsCurrentTrue()
        .orElseThrow(
            () -> new ResourceNotFoundException("Aucune année universitaire courante définie"));
  }
  ...
  public AcademicYear create(LocalDate dateDebut, LocalDate dateFin, boolean isCurrent) {
    ...
    AcademicYear annee =
        AcademicYear.builder().dateDebut(dateDebut).dateFin(dateFin).isCurrent(isCurrent).build();
